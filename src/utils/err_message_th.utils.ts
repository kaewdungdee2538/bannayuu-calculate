export class ErrMessageUtilsTH{
    ...
    errStartDateNotFound = 'ไม่พบวัน-เวลาเข้า'
    errStartDateNotFormat = 'วัน-เวลาเข้า รูปแบบไม่ถูกต้อง'
    errStopDateNotFound = 'ไม่พบวัน-เวลาออก'
    errStopDateNotFormat = 'วัน-เวลาออก รูปแบบไม่ถูกต้อง'
